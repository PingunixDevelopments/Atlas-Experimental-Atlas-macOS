...
NYRION_VERSION = "Atlas (macOS/Linux edition)"
BUILD = "26S1.2"
PREFIX = "QopWarren Build 6018 - Prefix QWE"
command_history = []
...
def qwe_show_help():
    ...
    print(" qwe unix         - Show Atlas macOS build")
...
def qwe_unix():
    print("Atlas 26S1.1: Special macOS/Linux Mid December/Early January 2026 build")
    print("QopWarren 6017: Special macOS/linux December/January 2026 build")
    print("macOS/Linux is always a rolling release! So the version on macOS is always newer then")
